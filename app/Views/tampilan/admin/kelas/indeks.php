...
<section class="content-header">
    <h1>Master Kelas</h1>
    <ol class="breadcrumb">
        <li><a href="<?= site_url('admin/kelas'); ?>"><i class="fa fa-dashboard"></i> Master Kelas</a></li>
    </ol>
</section>
<!-- header konten -->
                        ...
                        <tr>
                            ...
                            <td>
                                <a
                                    ...
                                    href="<?= site_url(['admin', 'kelas', 'edit', $k->id_kelas]); ?>"
                                ><i class="fa fa-pencil"></i></a>
                                <a
                                    class="btn btn-danger"
                                    href="<?= site_url(['admin', 'kelas', 'hapus', $k->id_kelas]); ?>"
