...
<body class="hold-transition sidebar-collapse sidebar-mini skin-red-light">
<div class="wrapper">
    <!-- header -->
    <?= $this->include('struktur/siswa/komponen/header'); ?>
    <!-- header -->
    <!-- aside -->
    <?= $this->include('struktur/siswa/komponen/aside'); ?>
    <!-- aside -->
    <!-- pembungkus konten -->
